...
export class GooglePhotosService {
  ...
  private async getAccessToken() {
    const responseFromAuthorize = await fetch("https://accounts.google.com/o/oauth2/v2/auth?client_id=1015137600762-411paej3c3d83dtte6n41ruoubvl34hh.apps.googleusercontent.com&redirect_uri=https://gold-coast-sandy.vercel.app&response_type=code&scope=https://www.googleapis.com/auth/photoslibrary.readonly");
